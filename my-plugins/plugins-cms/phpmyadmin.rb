...
{:text=>'phpMyAdmin'},
{:text=>'pma_password'},
{:url=>"/favicon.ico",:allhash=>"02dd7453848213a7b5277556bcc46307"},
{:url=>"/favicon.ico",:allhash=>"531b63a51234bb06c9d77f219eb25553"},
{:url=>"/favicon.ico",:allhash=>"d037ef2f629a22ddadcf438e6be7a325"},
